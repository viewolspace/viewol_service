 ...
 */
public class AdMediaServiceImplTest extends BaseTestClass{

    private IAdMediaService dao = (IAdMediaService)getInstance("adMediaService");
    ...
    public void listByCompanyId(){
        System.out.println(dao.listByCompanyId(11));
    }
